class UserStocksController < ApplicationController
   ...
   if params[:stock_is].present?
    ...
    respond_to do |format|
      if @user_stock.save
        ...
        notice: "#{@user_stock.stock.ticker} Stock added to portfolio" }
  ...
  def update
    respond_to do |format|
      if @user_stock.update(user_stock_params)
        format.html { redirect_to my_portfolio_path, notice: 'User stock was successfully updated.' }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'User stock deleted.' }
